...
<p>
A class of JSX have following characteristics.
</p>

<ul>
<li>all classes derive from the built-in Object class</li>
...
<p>
For example, <code>class E extends A implements C, D</code> means: C can override members of A (*1), D can override members of the production of *1 (*2), and that E can override members of the production of *2.
</p>
...
<p>
The example below defines a class called <em>Human</em> with a member variable <em>_name</em>, constructor function that takes a string as an argument, and a non-static member function (i.e. method) called <i>say</i>, that does not take any arguments and returns void).
<p>
...
<p>
A member function is defined by either of the following form. Arguments should have their types being annotated. The type after the closing parenthesis at the end of the argument list designates the return type of the function. Function that is not attributed abstract should have body. Function that is attributed abstract may have body.
</p>

<?= $context->{prettify}->('jsx', <<'EOT')
// function with body
attribute* function funcname([arg1 : type[, arg2 : type, ...]]) : type { statement* }
...
<p>
Member functions and variables can be referred to by applying the "." operator against a class name (for static members) or against a variable of the class type (or <em>this</em>).
</p>
...
<p>
An interface in JSX is similar to that of Java, except for the fact that it may have abstract variables. All the non-static functions are implicitly marked as <em>abstract</em>, and they cannot have bodies. An interface may <em>implement</em> other intefaces.
</p>
